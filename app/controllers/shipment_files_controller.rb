    ...
    respond_to do |format|
      format.html { 
        ...
        if @shipment_file.save
          flash[:shipment_file_id] = @shipment_file.id
          flash[:notice] = 'Shipment was successfully created and is being saved by JPEGger.' 
          redirect_back fallback_location: root_path
#          redirect_to root_path(shipment_file_id: @shipment_file.id)
        else
          render :new
        end
        }
  ...
  private
    ...
    def shipment_file_params
      ...
      params.require(:shipment_file).permit(:capture_sequence_number, :ticket_number, :name, :file, :user_id, :customer_number, :customer_name, :branch_code, :location, :event_code, :event_code_id, 
        :shipment_id, :container_number, :booking_number, :contract_number, :hidden, :blob_id, :yard_id, :camera_name, :camera_group)
    end
end
